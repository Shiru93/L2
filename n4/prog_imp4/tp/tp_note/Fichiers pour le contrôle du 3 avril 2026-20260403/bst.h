...
/** Deletes a node label v in a BST */
/* and returns the updated BST */
/** N.B. This function calls partition_BST */
link delete_node_BST(link h, item v);

/** Puts a BST into balance, by recursively */
/* putting the median node at the root */
link balance_BST(link h);

/** Returns the address of the BST resulting from merging */
