...
int main(int argc, char *argv[])
{
	...
	int (*listeOperations[4])(int, int) = {&somme, &produit, &difference, &quotient};
	...
	if (strcmp(argv[2], "plus")==0){
		printf("%d\n",listeOperations[0](a,b));
		return(EXIT_SUCCESS);
	}
	if (strcmp(argv[2], "fois")==0){
		printf("%d\n",listeOperations[1](a,b));
		return(EXIT_SUCCESS);
	}
	if (strcmp(argv[2], "moins")==0){
		printf("%d\n",listeOperations[2](a,b));
		return(EXIT_SUCCESS);
	}
	if (strcmp(argv[2], "divise_par")==0){
		printf("%d\n",listeOperations[3](a,b));
		return(EXIT_SUCCESS);
	}
	else{
