...
Proof.
  destruct b1.
  - rewrite (andb_true_l (b2 && b3)).
    rewrite (andb_true_l b2).
    reflexivity.
  - rewrite (andb_false_l (b2 && b3)).
    rewrite (andb_false_l b2).
    reflexivity.
Qed.
...
Proof.
  destruct b.
  - rewrite negb_true. reflexivity.
  - rewrite negb_false. reflexivity.
Qed.
...
Proof.
  Time destruct b1, b2, b3, b4, b5, b6, b7, b8; simpl; reflexivity.
  (* Time rewrite andb_false_r; reflexivity. *)
Qed.
...
Proof.
  ...
  - simpl. reflexivity.
  - destruct t2.
    + rewrite andt_truet_l; rewrite andt_truet_r; reflexivity.
    + rewrite andt_falset_l; rewrite andt_falset_r; simpl; reflexivity.
    + destruct t3; simpl; reflexivity.
Qed.
...
Proof.
  destruct t1.
  - rewrite andt_truet_l.
    rewrite andt_truet_r.
    reflexivity.
  - rewrite andt_falset_l.
    rewrite andt_falset_r.
    reflexivity.
...
Proof.
  (* Time rewrite andt_falset_r; reflexivity. *)
  Time destruct t1, t2, t3, t4, t5, t6, t7, t8; simpl; reflexivity.
Qed.
End Ternary.
